...
-- ============================================================ ADDITIONS 2026-07-04
-- Recall a claimed job (parent takes it back → open), per-event chat, and to-do lists.
...
-- Private (private=true, owner_id = the person): only that person (+ parents).
